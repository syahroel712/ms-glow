...
if(mysql_num_rows($brg)>0){
	$cr=mysql_query("select * from kanvas_tmp where kode_barang='$_POST[kodebarang]' and id_user='$kode_user'");
...
<?php
		...
		mysql_query("insert into kanvas_tmp values('','$kode_user','$_POST[kodebarang]','$_POST[hrg]','$_POST[jml]','$_POST[dc]')");
	}
