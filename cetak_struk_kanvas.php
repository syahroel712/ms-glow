	...
	<body onLoad="javascript:print()">
		...
		<table width="100%" border="2px" align="center" style="font-size:10px; border:none">
			...
			<tr>
				...
				$tot=0;
				$totharga =0;
				$b = mysql_query("select *,sum(tb_barang_kanvas.jml)as tot, tb_barang.satuan, tb_barang_kanvas.diskon from tb_barang_kanvas join tb_barang on tb_barang.kode_barang=tb_barang_kanvas.kode_barang where tb_barang_kanvas.nota='$_GET[id]' group by tb_barang_kanvas.kode_barang");
			...
			<tr style="font-size:9px" border="1">
				...
				<td style="width:80px"><?php echo $r["kode_barang"] ?></td>
				
				<td><?php echo $r["nama_barang"] ?></td>

				<td style="width:40px"><?php echo $r["tot"] ?> <?php echo $r["satuan"] ?></td>

				<td style="width:40px"><?php echo number_format($r["harga_satuan"],0) ?></td>

				
				
				<td style="width:40px"><?php echo $diskon; ?></td>

				<td style="width:40px" align="right"> <?php echo number_format($tot, 0); ?></td>
		...
		<tr border="1">
			...
			<td colspan="6" align="left"><b> <?php echo terbilang($totharga); ?> RUPIAH</b></td>
